...
interface DriverTabItem {
  routeName: DriverTabRouteName;
  activePrefix: string;
  label: string;
...
const driverTabItems: DriverTabItem[] = [
  {
...
function DriverPrivateTabBar({ state, navigation }: BottomTabBarProps) {
